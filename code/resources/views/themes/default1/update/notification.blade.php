...
<li class="dropdown notifications-menu">
    ...
    <ul class="dropdown-menu" style="width:500px">
        @if($notification->count()==1)
            <li class="header">01 atualização disponível.</li>
        @elseif($notification->count()>1)
            <li class="header">{!! $notification->count() !!} atualizações disponíveis.</li>
        @else
            <li class="header">Nenhuma atualização disponível.</li>
        @endif
