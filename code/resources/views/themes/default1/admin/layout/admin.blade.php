...
<html>
	<head>
		...
		<![endif]-->
		<link href="{{asset("lb-faveo/css/tikiri-admin.css")}}" rel="stylesheet" type="text/css" />
	...
	<body class="skin-yellow fixed">
		...
		<div class="wrapper">
			<header class="main-header">
				<a href="{{url('/')}}/admin" class="logo"><img src="{{ asset('lb-faveo/media/images/logo.png') }}" width="100px"></a>
				...
				<nav class="navbar navbar-static-top" role="navigation">
					...
					<div class="collapse navbar-collapse" id="navbar-collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							{{--
							Atualizações automáticas desabilitadas nas primeiras versoes do Tikiri
							...
							<li class="dropdown notifications-menu" id="myDropdown">
								...
								<ul class="dropdown-menu" style="width:500px">
									...
									<li class="header">Você tem {!! $notifications->count() !!} notificaçoes. <a class="pull-right" id="read-all" href="#">Marcar todas como lidas.</a></li>
									...
									<ul class="menu">
										...
										<li  class="task" style="list-style: none;margin-left: -30px"><span>&nbsp<img src="{{$notification -> users -> profile_pic}}" class="img-circle"  style="width:6%;height: 5%" alt="User Image" />
												<a href="{!! route('ticket.thread', $notification->notification->model_id) !!}" id='{{ $notification -> notification_id}}' class='noti_User'>
													{!! $notification->notification->type->message !!} {!! Lang::get('lang.with-id') !!} "{!!$notification->notification->model->ticket_number!!}"
												</a></span>
										</li>
							...
							<li class="footer"><a href="{{ url('notifications-list')}}">VER TODAS</a>
							</li>
						</ul>
						</li>
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header" style="background-color:#343F44;">
									...
									<p>
										...
										<small>{{ Lang::get('lang.'.$auth_user_role) }}</small>
									</p>
									@endif
								</li>
								<!-- Menu Footer-->
			...
			<footer class="main-footer">
				...
				?>
				<strong>{!! Lang::get('lang.copyright') !!} &copy; {!! date('Y') !!}  <a href="{!! $company->website !!}" target="_blank">{!! $company->company_name !!}</a>.</strong> {!! Lang::get('lang.all_rights_reserved') !!}. {!! Lang::get('lang.powered_by') !!} <a href="http://www.tikiri.com.br/" target="_blank">TIkiri</a>
			</footer>
		</div><!-- ./wrapper -->
		<!-- jQuery 2.1.3 -->
