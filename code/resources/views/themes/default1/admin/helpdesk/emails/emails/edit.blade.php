    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-xs-4 form-group {{ $errors->has('department') ? 'has-error' : '' }}">
                ...
                {!!Form::select('department', [''=>'--Padrão do Sistema--','Departamentos'=>$departments->lists('name','id')->toArray()],null,['class' => 'form-control select']) !!}
            </div>
            <!-- priority -->
            <div class="col-xs-4 form-group {{ $errors->has('priority') ? 'has-error' : '' }}">
                ...
                {!!Form::select('priority', [''=>'--Padrão do Sistema--','Prioridades'=>$priority->lists('priority_desc','priority_id')->toArray()],null,['class' => 'form-control select']) !!}
            </div>
            <!-- help topic -->
            <div class="col-xs-4 form-group {{ $errors->has('help_topic') ? 'has-error' : '' }}">
                {!! Form::label('help_topic',Lang::get('lang.help_topic')) !!}
                {!! $errors->first('help_topic', '<spam class="help-block">:message</spam>') !!}
                {!!Form::select('help_topic', [''=>'--Padrão do Sistema--','Catálogo de Serviços'=>$helps->lists('topic','id')->toArray()],null,['class' => 'form-control select']) !!}
            </div>
            <!-- status -->
    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-xs-2 form-group {!! $errors->has('sending_protocol') ? 'has-error' : ''!!}" id="sending_protocol_error">
                ...
                {!!Form::select('sending_protocol',[''=>'Selecione','Drives'=>$services],$emails->getCurrentDrive(),['class' => 'form-control select','id'=>'service']) !!}
            </div> 
            <!-- sending hoost -->
