        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-xs-4 form-group {!! $errors->has('department') ? 'has-error' : ''!!}" id="department_error">
                    ...
                    {!!Form::select('department', [''=>'--Padrão do Sistema--','Departamentos'=>$departments->lists('name','id')->toArray()],null,['class' => 'form-control select', 'id' => 'department' ]) !!}
                </div>
                <!-- Priority -->
                <div class="col-xs-4 form-group {!! $errors->has('priority') ? 'has-error' : ''!!}" id="priority_error">
                    ...
                    {!!Form::select('priority', [''=>'--Padrão do Sistema--','Prioridades'=>$priority->lists('priority_desc','priority_id')->toArray()],null,['class' => 'form-control select', 'id' => 'priority']) !!}
                </div>
                <!-- Help topic -->
                <div class="col-xs-4 form-group {!! $errors->has('help_topic') ? 'has-error' : ''!!}" id="help_topic_error">
                    ...
                    {!!Form::select('help_topic', [''=>'--Padrão do Sistema--','Catálogo de Serviços'=>$helps->lists('topic','id')->toArray()],null,['class' => 'form-control select', 'id' => 'help_topic']) !!}
                </div>
                <!-- status -->
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group {!! $errors->has('fetching_encryption') ? 'has-error' : ''!!}" id="fetching_encryption_error">
                    ...
                    {!!Form::select('fetching_encryption',[''=>'-----Selecione-----','ssl' => 'SSL', 'tls' => 'TLS', 'starttls' => 'STARTTLS'],null,['class' => 'form-control select', 'id' => 'fetching_encryption']) !!}
                </div>
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group {!! $errors->has('sending_protocol') ? 'has-error' : ''!!}" id="sending_protocol_error">
                    ...
                    {!!Form::select('sending_protocol',[''=>'Selecione','Drives'=>$services],null,['class' => 'form-control select','id'=>'service']) !!}
                </div> 
                <!-- sending hoost -->
                ...
                <div class="col-xs-2 form-group {!! $errors->has('sending_encryption') ? 'has-error' : ''!!}" id="sending_encryption_error">
                    ...
                    {!!Form::select('sending_encryption',[''=>'-----Selecione-----','ssl' => 'SSL', 'tls' => 'TLS', 'starttls' => 'STARTTLS'],null,['class' => 'form-control select']) !!}
                </div> 
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div id="head">
                    ...
                    <br/>
                    <br/>
                    <center><h3 style="color:#80DE02;">Testando o servidor de email de entrada e saída</h3></center>
                    <br/>
                    <center><h4>Aguarde enquanto o teste está em andamento ...</h4></center>
                    <center><h4>(Não use o botão "Atualizar" ou "Voltar")</h4></center>
                    <br/>
                </div>
            </div>
        </div>
    ...
    $('#form').on('submit', function () {
        ...
        $.ajax({
            ...
            error: function (json) {
                ...
                $("#head").html("<div class='alert alert-danger'><strong>Ooops!</strong> Houveram alguns problemas com a sua entrada de dados.<br><br><ul>" + res + "</ul></div>");
                $('html, body').animate({scrollTop: $("#form").offset().top}, 500);
            }
        });
        return false;
