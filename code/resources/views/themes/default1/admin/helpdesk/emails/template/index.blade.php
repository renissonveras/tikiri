...
@if(Session::has('success'))
	...
	<tr>
		...
		<td>
			...
			<a href="{{route('template.edit',$template->id)}}" class="btn btn-info btn-xs btn-flat"><i class="fa fa-edit" style="color:black;"> </i> Editar</a>
			<!-- To pop up a confirm Message -->
				{!! Form::button('<i class="fa fa-trash" style="color:black;"> </i> Excluir',
            		['type' => 'submit',
