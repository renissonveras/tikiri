                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        <ul class="tabs tabs-horizontal nav navbar-nav">
                            <li class="active"><a data-target="#tabA" href="#">Início</a></li>
                            <li><a data-target="#tabB" href="#">Equipe</a></li>
                            <li><a data-target="#tabC" href="#">Departamento</a></li>
                            <li><a data-target="#tabD" href="#">Usuários</a></li>
                        </ul>
