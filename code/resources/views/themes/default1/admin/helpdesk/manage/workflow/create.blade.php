    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="form-group {!! $errors->has('target_channel') ? 'has-error' : '' !!}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('target_channel', [''=> '-- '.Lang::get('lang.select_a_channel').' --', 'A-0' => 'Todos', 'A-1' => 'Formulários Web', 'A-4' => 'Chamadas API', 'A-2' => 'Emails'], null,['class' => 'form-control', 'id' => 'execution_order']) !!}
                </div>
            </div>
        </div>
    </div>
