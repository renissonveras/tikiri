            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                        ...
                        {!!Form::select('type', [''=>'Selecione um Tipo','types'=>$type->lists('type','id')] ,null,['class' => 'form-control'] ) !!}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('visibility') ? 'has-error' : '' }}">
                        ...
                        {!!Form::select('visibility', [''=>'Selecione a Visibilidade','visibilities' =>$visibility->lists('visibility','id')],null,['class' => 'form-control'] ) !!}
                    </div>
                </div>
