            ...
            <div class="modal fade" id="addNewCategoryModal3" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            O que deve ser feito com o conteúdo de propriedade desse usuário?</br>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        Tem certeza?
                        Mudar perfil do usuário para CLIENTE!
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4"><span id="legend-holder" style="background-color: #6DC5B2;"></span>&nbsp; <span class="lead"> <span id="total-reopen-tickets" class="lead"></span> {!! Lang::get('lang.tickets') !!} {!! Lang::get('lang.total_reopen') !!}  </span></div> 
                                            <div class="col-md-4"><span id="legend-holder" style="background-color: #E3B870;"></span>&nbsp; <span class="lead"> <span id="total-closed-tickets" class="lead"></span> {!! Lang::get('lang.tickets') !!} {!! Lang::get('lang.total_closed') !!}  </span></div> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row" id="hide">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <spam id="error-name" style="display:none;position:fixed" class="call-out text-red">Este é um campo obrigatório</spam>
                                <spam id="error-name1" style="display:none;position:fixed" class="call-out text-red">Já utilizado!</spam>
                                <br/>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <spam id="error-website" style="display:none" class="help-block text-red">Já utilizado!</spam>
                                <br/>
                            </div>
                        </div>
                        <div class="col-md-6">
