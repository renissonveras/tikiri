        ...
        <div class="col-md-6">
            ...
            <div class="box-body">
                <div class="form-group row">
                    @if($user->gender == 1)
                    <div class='col-xs-4'><label>{!! Lang::get('lang.gender') !!}:</label></div> <div class='col-xs-7'>{{ 'Masculino' }}</div>
                    @else
                    <div class='col-xs-4'><label>{!! Lang::get('lang.gender') !!}:</label></div> <div class='col-xs-7'>{{ 'Feminino' }}</div>
                    @endif
                </div>
                <div class="form-group  row">
                ...
                <div class="form-group  row">
                    <div class='col-xs-4'><label>{!! Lang::get('lang.role') !!}:</label></div> <div class='col-xs-7'>  {!! Lang::get('lang.'.$user->role) !!}</div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
