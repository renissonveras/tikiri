...
<div class="box box-primary">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                        <label>{!! Lang::get('lang.internal_phone') !!}:</label>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('helptopic', ['Tópico'=>$helptopic->lists('topic','id')->toArray()],null,['class' => 'form-control select','id'=>'selectid']) !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <!-- sla plan -->
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('assignto', [''=>'Selecione um atendente','Atendentes'=>$agents->lists('first_name','id')->toArray()],null,['class' => 'form-control select']) !!}
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        {!! Form::select('priority', ['Prioridade'=>$Priority->lists('priority_desc','priority_id')->toArray()],null,['class' => 'form-control select']) !!}
                    </div>
    ...
    <div class="box-footer">
        <div class="row">
            ...
            <div class="col-md-3">
                <input type="submit" value="{!! Lang::get('lang.create_ticket') !!}" class="btn btn-primary" onclick="this.disabled=true;this.value='Enviando, favor aguardar...';this.form.submit();">
            </div>
        </div>
    </div>
</div><!-- /. box -->
...
<script type="text/javascript">
        ...
        $('#form').submit(function () {
            ...
            if (duedate) {
                ...
                if (pattern.test(duedate) === true) {
                    ...
                    $('#clear-up').remove();
                    $('#box-header1').append("<div id='clear-up'><br><br><div class='alert alert-danger alert-dismissable'><i class='fa fa-ban'></i><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button> Data de vencimento inválida</div></div>");
                    return false;
                }
            }
        });
    ...
    $(function () {
        ...
        $('#datemask').datepicker( "option", "dateFormat", "dd/mm/yy");
    });
</script>
