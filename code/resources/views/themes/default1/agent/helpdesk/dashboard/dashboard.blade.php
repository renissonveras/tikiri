    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <a href="{!! route('inbox.ticket') !!}">
            <div class="info-box">
                ...
                <div class="info-box-more">{!! Lang::get('lang.inbox') !!}</div>
            </div><!-- /.info-box -->
        </a>
    </div><!-- /.col -->
    <!-- <div class="col-md-3 col-sm-6 col-xs-12"> -->
        ...
        <a href="{!! route('unassigned') !!}">
            <div class="info-box">
                ...
                <div class="info-box-content">
                 ...
                 <div class="info-box-more">{!! Lang::get('lang.unassigned') !!}</div>
            </div><!-- /.info-box -->
        </a>
    </div><!-- /.col -->
    ...
    <div class="col-md-2 col-sm-6 col-xs-12">
        <a href="{!! route('overdue.ticket') !!}">
            <div class="info-box">
                ...
                <div class="info-box-more">{!! Lang::get('lang.overdue') !!}</div>
            </div><!-- /.info-box -->
        </a>
    </div><!-- /.col -->
    <!-- <div class="col-md-3 col-sm-6 col-xs-12"> -->
    <div class="col-md-2 col-sm-6 col-xs-12">
        <a href="{!! route('myticket.ticket') !!}">
            <div class="info-box">
                ...
                <div class="info-box-more">{!! Lang::get('lang.my_tickets') !!}</div>
            </div><!-- /.info-box -->
        </a>
    </div><!-- /.col -->
     ...
     $todaytickets = App\Model\helpdesk\Ticket\Tickets::where('status', '=', 1)->whereDate('tickets.duedate','=', \Carbon\Carbon::now()->format('Y-m-d'))->where('dept_id', '=', $dept->id)->count();
      ...
      ?>
            ...
            <div class="info-box">
                <span class="info-box-icon bg-orange"><i class="glyphicon glyphicon-eye-open"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text"></span>
                    <span class="info-box-number">{{ $todaytickets }} <small> Tickets</small></span>
                </div><!-- /.info-box-content -->
                <div class="info-box-more">{!! Lang::get('lang.duetoday') !!}</div>
            </div><!-- /.info-box -->
        </a>
          <!-- /.info-box -->
        </div>
...
<div class="box box-info">
    <div class="box-header with-border">
        ...
        <div class="pull-right box-tools">
            <button type="button" class="btn btn-primary box-btn btn-sm" data-toggle="modal" data-target="#modal-default">
                 <i class="fa fa-filter"></i>
            </button>
            <button type="button" class="btn btn-primary btn-sm box-btn" data-widget="collapse" data-toggle="tooltip" title="" data-original-title="Collapse">
    ...
    <div class="box-footer">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <span> 
                    <span id="total-created-tickets" ></span> {!! Lang::get('lang.tickets') !!} {!! Lang::get('lang.total_created') !!}
                </span>
            </div> 
            <div class="col-md-3">
                <span id="legend-holder" style="background-color: #469D6B;"></span>&nbsp; 
                <span> 
                    <span id="total-reopen-tickets"></span> 
                    {!! Lang::get('lang.tickets') !!} {!! Lang::get('lang.total_reopen') !!}
                </span>
            </div> 
            <div class="col-md-3">
                <span id="legend-holder" style="background-color: #E3B870;"></span>&nbsp; 
                <span> 
                    <span id="total-closed-tickets"></span> 
                    {!! Lang::get('lang.tickets') !!} {!! Lang::get('lang.total_closed') !!}
                </span>
            </div> 
        </div>
    </div>
    ...
    <form id="foo">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">{!! Lang::get('lang.filter') !!}</h4>
          </div>
          <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                        {!! Form::label('end_date', Lang::get('lang.end_date')) !!}
