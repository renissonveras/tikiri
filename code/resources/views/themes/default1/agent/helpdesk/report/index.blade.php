        ...
        <form id="foo">
            ...
            <div  class="form-group">
                    ...
                    <div class='col-sm-1' style="padding-right:0px;padding-left:0px">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="#" id="stop"><input type="checkbox" name="open" id="open">{!! lang::get('lang.tickets') !!} {!! lang::get('lang.total_created') !!} </a></li>
                                <li><a href="#" id="stop"><input type="checkbox" name="closed" id="closed">{!! lang::get('lang.tickets') !!} {!! lang::get('lang.total_closed') !!} </a></li>
                                <li><a href="#" id="stop"><input type="checkbox" name="reopened" id="reopened">{!! lang::get('lang.tickets') !!} {!! lang::get('lang.total_reopen') !!} </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class='col-sm-1'>
                        {!! Form::label('filter', lang::get('lang.filter')) !!}<br>
                        <input type="submit" class="btn btn-primary" value="{!! lang::get('lang.send') !!}" id="submit">
                    </div>
                    <br/>
                    <div class="col-md-4">
                        <div class="btn-group">
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" id="click_day">Dia</button>
                                <button type="button" class="btn btn-default" id="click_week">Semana</button>
                                <button type="button" class="btn btn-default" id="click_month">Mês</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2"><span id="legend-holder" style="background-color: #6C96DF;"></span>&nbsp; <span> <span id="total-created-tickets1" ></span> {!! Lang::get('lang.tickets') !!} {!! Lang::get('lang.total_created') !!}</span></div> 
                    <div class="col-md-2"><span id="legend-holder" style="background-color: #6DC5B2;"></span>&nbsp; <span> <span id="total-reopen-tickets1"></span> {!! Lang::get('lang.tickets') !!} {!! Lang::get('lang.total_reopen') !!}</span></div> 
                    <div class="col-md-2"><span id="legend-holder" style="background-color: #E3B870;"></span>&nbsp; <span> <span id="total-closed-tickets1"></span> {!! Lang::get('lang.tickets') !!} {!! Lang::get('lang.total_closed') !!}</span></div> 
                </div>
            </div>
        </form>
...
//                                    }
                                    ...
                                    if (i == 1) {
                                        ...
                                        var cell = row.insertCell(0);
                                        cell.innerHTML = "<b>{!! Lang::get('lang.total_created') !!}</b>";
                                        var cell = row.insertCell(0);
