...
<html>
	<head>
		...
		<link href="{{asset("lb-faveo/css/tikiri-agent.css")}}" rel="stylesheet" type="text/css" />        
	...
	<body class="skin-purple fixed">
		<div class="wrapper">
			<header class="main-header">
				<a href="{{url('/')}}/dashboard" class="logo"><img src="{{ asset('lb-faveo/media/images/logo.png')}}" width="100px;"></a>
				<?php
				...
				<nav class="navbar navbar-static-top">
					...
					<div class="collapse navbar-collapse" id="navbar-collapse">
						...
						<ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
							...
							<li @yield('Report')><a href="{{URL::route('report.index')}}" onclick="clickReport(event);">{!! Lang::get('lang.reports') !!}</a></li>
							@endif
