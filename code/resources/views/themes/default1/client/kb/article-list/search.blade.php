...
<div class="site-hero">
    <ol class="breadcrumb breadcrumb-custom">
        <li class="text">Você está aqui: </li>
        <li>Home</li>
...
<div id="content" class="site-content col-md-9">
    ...
    <article class="format-standard type-post hentry clearfix">
        ...
        <a class="readmore-link" href="{{url('show/'.$arti->slug)}}">Leia mais...</a>
        </blockquote>
        ...
        <hr>
        @empty 
        <p><h3><b>Desculpa!</b></h3> Nenhum resultado encontrado para o que você buscou. Nesse caso sugerimos que você <a href="{{URL::route('form')}}">abra um chamado técnico (Ticket)</a>.</p>
        @endforelse
