...
<div class="box box-primary">
    <div class="box-header">
        ...
        <div class="pull-right">
            ...
            <a href="{{url('ticket/print/'.$ticket->id)}}" target="_blank" class="btn btn-default"><i class="fa fa-print" style="color:blue;"> </i> Imprimir</a>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li id="close"><a href="#"><i class="fa fa-check" style="color:green;"> </i>Fechado</a></li>

                    <li id="resolved"><a href="#"><i class="fa fa-check-circle-o " style="color:green;"> </i> Resolvido</a></li>
                </ul>
            </div>
