...
@section('BodyInitInclude')
<div class="profile-content profile-div">
    <div class="container">
        <div class="row">
            <div class="profile">
                <div class="avatar">
                    <img src="{{Auth::user()->profile_pic}}" alt="Perfil" width="100" height="100" class="img-circle img-responsive img-raised">
                </div>
                <div class="name">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group is-fileinput {{ $errors->has('profile_pic') ? 'has-error' : '' }}">
                        <!-- profile pic -->
