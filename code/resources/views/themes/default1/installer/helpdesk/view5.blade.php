...
@section('content')
 <div id="form-content">
<div ng-app="myApp">
        <h1 style="text-align: center;">Informações do Local</h1>
    ...
    <div ng-controller="MainController">
            <table>                
                <p>Estamos quase terminando! Agora preencha as informações abaixo.</p>
                <h1 style="border-top:1px solid #dedede; border-bottom:1px solid #dedede; padding: 10px 0px 10px 0px;">Informações do Administrador</h1>
                <p>Por favor, forneça as seguintes informações. Não se preocupe, você sempre pode alterar essas configurações depois.</p>
                <div>
                    <tr>
                        <td>
                            <label for="box1">Nome:<span style="color
                    ...
                    <tr>
                        <td>
                            <label for="box2">Sobrenome (Último)<span style="color
                                : red;font-size:12px;">*</span></label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label for="box2">E-mail<span style="color
                                : red;font-size:12px;">*</span></label>
                        </td>
                        <td>
            ...
            <table>
                ...
                <div>
                    ...
                    <tr>
                        <td>
                            <label for="box4">Usuário <span style="color
                    ...
                    <tr>
                        <td>
                            <label for="box4">Senha <span style="color
                                    : red;font-size:12px;">*</span>
                            </label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label for="box5">Confirme a Senha<span style="color
                                    : red;font-size:12px;">*</span>
                            </label>
                        </td>
                        <td>
            ...
            <table>
                ...
                <div>
                    <tr>
                        <td>
                            {!! Form::label('date','Formato de Data e Hora') !!}
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="side-by-side clearfix moveleft">
                                <div>
                                    <select name="timezone" data-placeholder="Selecione um timezone..." class="chosen-select" style="width:295px;" tabindex="2">
                                        ...
                                        <option value="America/Maceio">America/Maceió</option>
                                        <option value="America/Araguaia">America/Araguaia</option>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>  
                                <select name="language" data-placeholder="Selecione o Idioma..." class="chosen-select" style="width:295px;" tabindex="2">
                                    @foreach($values as $value)
                                        <option <?php if($value=="pt") { ?> selected="true" <?php } ?> value="{!! $value !!}">{!! Config::get('languages.' . $value) !!}</option>
                                    @endforeach
                                </select>
                           </div>
                        </td>
            ...
            $("#postaccount input").each(function(){
                if($(this).attr('name') == 'firstname' ||
                   ...
                   $(this).attr('name') == 'confirmpassword'){
                    ...
                    $('#submitme').val('Instalando, favor aguarde...');
                }
            });
        });
