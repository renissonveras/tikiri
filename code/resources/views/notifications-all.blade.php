			...
			<div class="box">
				<div class="box-header">
					...
					<div class="pull-right">
						<a href="{{url('notifications-list/delete')}}" class="btn btn-danger">Excluir Todas</a>
					</div>
				</div>
				<!-- /.box-header -->
				<div class="row">
...
<li><a href="#">&raquo;</a>
							...
							<div class="box-body">
								<ul class="todo-list">
									...
									@endif
									@elseif($notification->notification && $notification->notification->type && $notification->notification->type->type == 'game')
					...
					({
						...
						success: function(response)
						{
							if (response == 1)
							{
								...
								var message = "Sucesso! Você excluiu a notificação com sucesso!";
								$("#alert21").show();
