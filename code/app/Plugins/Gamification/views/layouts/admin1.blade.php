...
<html>
    ...
    <body class="skin-yellow fixed">
        <?php
        $replacetop = 0;
        $replacetop = \Event::fire('gamification.admin.topbar.replace', array());

        if (count($replacetop) == 0) {
            $replacetop = 0;
        }
        $replaceside = 0;
        $replaceside = \Event::fire('gamification.admin.sidebar.replace', array());
                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            @endif
                            <?php \Event::fire('gamification.admin.topbar', array()); ?>
                        </ul>
...
<?php } ?>
                        ...
                        @endif
        <?php \Event::fire('gamification.admin.sidebar', array()); ?>
                    </ul>
                </section>
                <!-- /.sidebar -->
            </aside>
