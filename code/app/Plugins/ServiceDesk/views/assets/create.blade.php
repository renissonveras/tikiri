        ...
        <div class="row">
            {!! Form::open(['url'=>'#','method'=>'','files'=>true,'id'=>'asset-type-form']) !!}
                ...
                <div class="form-group col-md-6 {{ $errors->has('location_id') ? 'has-error' : '' }}">
                    ...
                    {!! Form::select('location_id',[''=>Lang::get('lang.select')],null,['class'=>'form-control','id'=>'location']) !!}
       ...
       // 
        $.ajax({
                ...
                error: function (json) {
                    ...
                    $("#response").html("<div class='alert alert-danger'><strong>Ooops!</strong> Houveram alguns problemas com a sua entrada de dados.<br><br><ul>" + res + "</ul></div>");
                    $('html, body').animate({ scrollTop: $("#heading").offset().top }, 500);
                }
            });
    }
