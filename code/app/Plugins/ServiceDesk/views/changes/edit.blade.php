    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="form-group col-md-12 {{ $errors->has('description') ? 'has-error' : '' }}">
                <label for="internal_notes" class="control-label" >{{Lang::get('lang.description')}}</label>
            ...
            <div class="form-group col-md-6 {{ $errors->has('asset') ? 'has-error' : '' }}">
                <label class=" control-label" >Ativo(s) de TI</label>
            ...
            <div class="form-group col-md-6 {{ $errors->has('attachments') ? 'has-error' : '' }}">
                <label class=" control-label" >{{Lang::get('service::lang.attachments')}}</label>
        ...
        <div class="box-footer">
            <div class="from-group">
                <input type="submit" value="{{Lang::get('service::lang.edit_change')}}" class="btn btn-success">
                 {!! Form::close() !!}
            </div>
        </div>
