...
<div class="box box-primary">
    ...
    <!-- form start -->
    {!! Form::open(['url'=>'service-desk/location-types/postedit1','method'=>'post']) !!}
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-4 form-group {{ $errors->has('organization') ? 'has-error' : '' }}">
                    ...
                    {!! Form::select('organization',[''=>Lang::get('lang.select'),'Organizações'=>$organizations],$sd_location->organization,['class'=>'form-control']) !!}
                </div>
            </div> 
            <div class="row">
