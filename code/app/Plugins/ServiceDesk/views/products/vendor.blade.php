    ...
    <div class="box-header">
        ...
        <div class="pull-right">
            <div class="btn-group">
                ...
                <a href="#add" data-toggle="modal" class="btn btn-primary" data-target="#add{{$product->id}}">Adicionar novo</a>

            </div>
            <div class="btn-group">

                <a href="#existing" data-toggle="modal" class="btn btn-primary" data-target="#existing{{$product->id}}">Adicionar existente</a>
    ...
    <div class="box-body">
        <table class="table table-condensed">
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <a href="{{url('service-desk/vendor/'.$vendor->id.'/edit')}}" class="btn btn-info">Editar</a>
                    </div>
                    <div class="btn-group">
                        <?php
            ...
            <?php $i++; ?>
            @empty 
            <tr><td>Nenhum fornecedor associado</td></tr>
            @endforelse
