        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a href="#rootcause"  data-toggle="modal" data-target="#rootcause{{$problem->id}}">Causa Raiz</a></li>
                    <li><a href="#impact"  data-toggle="modal" data-target="#impact{{$problem->id}}">Impacto</a></li>
                    <li><a href="#symptoms" data-toggle="modal" data-target="#symptoms{{$problem->id}}">Sintoma(s)</a></li>
                    <li><a href="#solution" data-toggle="modal" data-target="#solution{{$problem->id}}">Solução(s)</a></li>
                </ul>
            </div>
            <div class="btn-group">
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" ><i class="fa fa-spinner fa-spin" style="color:teal; display:none;" id="spin"></i>
                    Mudança <span class="caret"></span>
                </button>
                <ul class="dropdown-menu">
                    @if(!$problem->change())
                    <li><a href="#changenew"  data-toggle="modal" data-target="#changenew{{$problem->id}}">Nova mudança</a></li>
                    <li><a href="#changeold"  data-toggle="modal" data-target="#changeold{{$problem->id}}">Mudança existente</a></li>
                    @else 
                    <li><a href="#change-detach"  data-toggle="modal" data-target="#change-detach{{$problem->id}}">Desanexar {{str_limit($problem->change()->subject,5)}}</a></li>
                    @endif
                </ul>
            </div>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="#delete" data-toggle="modal" data-target="#delete{{$problem->id}}">Excluir</a></li>
                    @if($problem->status_type_id=='1')
                    <li><a href="{{url('service-desk/problem/'.$problem->id.'/close')}}">Fechar </a></li>
                    @endif
