<a href="#asset" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#asset{{$id}}">Associar Ativos de TI</a>
<div class="modal fade" id="asset{{$id}}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Ativos de TI</h4>
            </div>
...
function submit(value) {
    $("#submitTags").click(function () {
        ...
        $("#tagName").html('O valor é :: ' + $("input#text").val());
    });
}
