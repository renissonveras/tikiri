...
class ContractController extends BaseServiceDeskController {
        ...
        try {
            ...
            return \Datatable::Collection($contracts)
                            ...
                            ->addColumn('action', function($model) {
                                ...
                                return "<a href=" . url('service-desk/contracts/' . $model->id . '/edit') . " class='btn btn-info btn-sm'>Editar</a> "
                                        . $delete
                                        . " <a href=" . url('service-desk/contracts/' . $model->id . '/show') . " class='btn btn-primary btn-sm'>Ver</a>";
                            })
                            ->searchColumns('name')
    ...
    public function handleCreate(CreateContractRequest $request) {
        ...
        return \Redirect::route('service-desk.contract.index')->with('message', Lang::get('service::lang.sucess_on_operation'));
    }
