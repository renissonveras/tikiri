...
class FormBuilderController extends BaseServiceDeskController {
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            if ($save) {
                $result = ["success" => Lang::get('service::lang.sucess_on_operation')];
            }
    ...
    public function getForm() {
        ...
        return \Datatable::Collection($form)
                        ...
                        ->addColumn('action', function($model) {
                            ...
                            $title = "Excluir $model->title";
                            $delete = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($model->id, $url, $title);
                            return "<a href=" . url('service-desk/form-builder/' . $model->id . '/edit') . " class='btn btn-sm btn-primary'>Editar</a> "
                                    . $preview.$delete;
                        })
                        ->searchColumns('title')
                        ->orderColumns('title')
