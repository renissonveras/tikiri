...
Breadcrumbs::register('check_ticket', function ($breadcrumbs, $id) {
    ...
    $breadcrumbs->push('Verificar Ticket');
});
...
Breadcrumbs::register('client.profile', function ($breadcrumbs) {
    $breadcrumbs->push('Meu Perfil');
});
Breadcrumbs::register('ticket2', function ($breadcrumbs) {
    $breadcrumbs->push('Meus Tickets', route('ticket2'));
});

Breadcrumbs::register('client-verify-number', function ($breadcrumbs) {
    $breadcrumbs->push('Perfil', route('client-verify-number'));
});
Breadcrumbs::register('post-client-verify-number', function ($breadcrumbs) {
    $breadcrumbs->push('Meu Perfil', route('post-client-verify-number'));
});
...
Breadcrumbs::register('article-list', function ($breadcrumbs) {
    $breadcrumbs->push('Lista de Artigos', route('article-list'));
});

Breadcrumbs::register('search', function ($breadcrumbs) {
    $breadcrumbs->push('Base de Conhecimento', route('home'));
    $breadcrumbs->push('Resultado da Busca');
});

Breadcrumbs::register('show', function ($breadcrumbs) {
    $breadcrumbs->push('Base de Conhecimento', route('home'));
    $breadcrumbs->push('Lista de Artigos', route('article-list'));
    $breadcrumbs->push('Artigo');
});
Breadcrumbs::register('category-list', function ($breadcrumbs) {
    $breadcrumbs->push('Lista de Categorias', route('category-list'));
});
...
Breadcrumbs::register('priority.edit', function ($breadcrumbs) {
    $breadcrumbs->push(Lang::get('lang.ticket_priority'), route('priority.index'));
    $breadcrumbs->push(Lang::get('lang.edit'), route('priority.index'));
});
...
Breadcrumbs::register('postaccount', function ($breadcrumbs) {
    $breadcrumbs->push('postaccount', 'postaccount');
});
