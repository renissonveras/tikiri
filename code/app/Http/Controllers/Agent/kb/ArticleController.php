	...
	public function getData()
	{
		...
		return Datatable::Collection($articles)
						...
						->addColumn('Actions', function ($model) {
							...
							return '<a href='.url("article/$model->id/edit").' class="btn btn-warning btn-xs">'.\Lang::get('lang.edit').'</a>&nbsp;<a href='.url("show/$model->slug").' class="btn btn-primary btn-xs">'.\Lang::get('lang.view').'</a>&nbsp;<span  data-toggle="modal" data-target="#deletearticle'.$model->id.'"><a href="#" ><button class="btn btn-danger btn-xs"></a> '.\Lang::get('lang.delete').' </button></span>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis2">Fechar</button>
								<a href='.url("article/delete/$model->slug").'><button class="btn btn-danger">Excluir</button></a>
							</div>
						</div>
					</div>
				</div>';
