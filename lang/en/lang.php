...
return [
    ...
    'otp_usage_info'                                             => 'If you disallow unverified users to create ticket, we\'ll send an email with verification link and an sms with OTP code to users. If email is set as non mandatory users will recieve username and password on their mobile. [NOTE: SMS will be sent using Tikiri SMS plugin].',
    ...
    'cron'                                => 'Job scheduler',
    'cron-jobs'                           => 'Cron jobs',
    'crone-url-message'                   => "These are Tikiri's job scheduler (cron job) URL for your system.",
    ...
    'Send_app_crash_reports_to_help_Ladybird_improve_Tikiri' => 'Send app crash reports to help Ladybird improve Tikiri',
    ...
    */
    ...
    'bugsnag-debugging'                  => 'Send app crash reports to help Ladybird improve Tikiri',
    ...
    'next_step'                                            => 'Next Step',
    'login_to_Tikiri'                                       => 'Login to Tikiri',
    ...
    'dummy_data_installation_message'                      => 'You are using Tikiri with dummy data, which should be used only for testing purpose. Your system will not fetch or send any mail as dummy data has minimal configuration settings. We recommend not to feed any live data in the system till you are testing the system. Once you are done with testing clear all dummy data and configure system settings to get started with the system.',
    'clear-dummy-data-agent-message'                       => 'Your Tikiri system has been installed with dummy data  which should be used only for testing purpose. Your system will not fetch or send any mail as dummy data has minimal configuration settings. We recommend not to feed any live data in the system till you are testing the system. Once you are done with testing contact your system admin to clean dummy data and configure system settings.',
    'clear-dummy-data'                                     => 'to clear dummy data.',
    'delete_dummy_data'                                    => 'Clean dummy data',
    'plugin-with-dummy-data-error-message'                 => 'You\'ve installed Tikiri with dummy data for testing. Plugins can only be used in live/production mode. If you are done with testing clear dummy data and start using Tikiri in live/production mode.',
