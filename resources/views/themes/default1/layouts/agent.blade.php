    ...
    <body class="skin-yellow fixed">
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="" class="logo"><b>Tikiri </b></a>
...
?>
            ...
            <strong>Copyright &copy; {!! date('Y') !!}  <a href="{!! $company->website !!}">{!! $company->company_name !!}</a>.</strong> Todos os direitos reservados. Distribuído por <a href="https://github.com/renissonveras/tikiri">Faveo</a>
                        </footer>
                    </div><!-- ./wrapper -->
